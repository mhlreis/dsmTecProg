    ...
    render() {
        ...
        if (this.state.tela === 'Clientes') {
            return (
                <>
                    {barraNavegacao}
                    <ListaCliente seletorView={this.selecionarView} dadosClienteAtualizacao={this.state.dadosClienteAtualizacao} onDataChange={this.handleDataChange} titulo="Clientes" tema="grey darken-2" />
                </>
            )
            ...
            return (
                <>
                    {barraNavegacao}
                    <ListaProdutoServico seletorView={this.selecionarView} titulo="Produtos e Serviços" tema="grey darken-2" produtosServicos={listaProdutosServicos} />
                </>
            )
